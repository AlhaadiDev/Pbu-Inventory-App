...
public class starter extends android.app.Service {
	...
	public void onCreate() {
        mostCurrent = this;
        if (processBA == null) {
		    processBA = new BA(this, null, null, "pbu.inventory.apps", "pbu.inventory.apps.starter");
        ...
        if (BA.isShellModeRuntimeCheck(processBA)) {
			processBA.raiseEvent2(null, true, "CREATE", true, "pbu.inventory.apps.starter", processBA, _service, anywheresoftware.b4a.keywords.Common.Density);
		}
