...
public class main extends Activity implements B4AActivity{
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		if (isFirst) {
			processBA = new BA(this.getApplicationContext(), null, null, "pbu.inventory.apps", "pbu.inventory.apps.main");
	...
	private void afterFirstLayout() {
        if (this != mostCurrent)
			return;
		activityBA = new BA(this, layout, processBA, "pbu.inventory.apps", "pbu.inventory.apps.main");
        ...
        if (BA.isShellModeRuntimeCheck(processBA)) {
			...
			processBA.raiseEvent2(null, true, "CREATE", true, "pbu.inventory.apps.main", processBA, activityBA, _activity, anywheresoftware.b4a.keywords.Common.Density, mostCurrent);
...
vis = vis | (inventorylist.mostCurrent != null);
vis = vis | (inventoryview.mostCurrent != null);
vis = vis | (home.mostCurrent != null);
vis = vis | (image.mostCurrent != null);
...
mostCurrent._activity.LoadLayout("intro",mostCurrent.activityBA);
 //BA.debugLineNum = 46;BA.debugLine="IRCircularRing1.startAnim";
...
mostCurrent._progressbar1 = new anywheresoftware.b4a.objects.ProgressBarWrapper();
 //BA.debugLineNum = 31;BA.debugLine="Dim num As Int";
_num = 0;
 //BA.debugLineNum = 34;BA.debugLine="Private Button1 As Button";
mostCurrent._button1 = new anywheresoftware.b4a.objects.ButtonWrapper();
 //BA.debugLineNum = 35;BA.debugLine="Private btnScramble As Button";
mostCurrent._btnscramble = new anywheresoftware.b4a.objects.ButtonWrapper();
 //BA.debugLineNum = 36;BA.debugLine="Private btnAbout As Button";
mostCurrent._btnabout = new anywheresoftware.b4a.objects.ButtonWrapper();
 //BA.debugLineNum = 38;BA.debugLine="Private btnVolume As Button";
mostCurrent._btnvolume = new anywheresoftware.b4a.objects.ButtonWrapper();
 //BA.debugLineNum = 39;BA.debugLine="Private IRCircularRing1 As IRCircularRing";
...
inventorylist._process_globals();
inventoryview._process_globals();
slidingpanels._process_globals();
home._process_globals();
image._process_globals();
...
_timer1.setEnabled(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 78;BA.debugLine="IRCircularRing1.stopAnim";
mostCurrent._ircircularring1.stopAnim();
 //BA.debugLineNum = 79;BA.debugLine="StartActivity(\"Login\")";
